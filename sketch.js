...
function createCash() {
  ...
  var cash = createSprite(Math.round(random(350, 50),40, 10, 10));
...
function createDiamonds() {
  ...
  var diamonds = createSprite(Math.round(random(360, 40),40, 10, 10));
...
function createjewelry() {
  ...
  var jewelry = createSprite(Math.round(random(40, 350),40, 10, 10));
...
function createSword(){
  ...
  var sword = createSprite(Math.round(random(40, 350),40, 10, 10));
